 ...
 * under the License.
 */
package zzy.zyproxy.core.util.proxy;
...
public final class HexDumpProxy {
    ...
    static final int LOCAL_PORT
        = Integer.parseInt(System.getProperty("localPort", "3316"));
    static final String REMOTE_HOST
        = System.getProperty("remoteHost", "127.0.0.1");
    static final int REMOTE_PORT
        = Integer.parseInt(System.getProperty("remotePort", "3306"));
